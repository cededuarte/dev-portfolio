...
function DegreeCard(props) {
  ...
  const card_body = style({
    borderBottom: `1px solid ${theme.educCard}`,
    borderLeft: `1px solid ${theme.educCard}`,
    borderRight: `1px solid ${theme.educCard}`,
    borderRadius: "7px",
    width: "90%",
    margin: "10px",
    boxShadow: `0px 1px 5px ${theme.educCard}`,
    transition: "all 0.2s ease-in-out",
    ":hover": {
      color: "rgba(255, 255, 255, 1)",
      boxShadow: `0 5px 15px ${theme.educCard}`,
    },
    "@media (max-width: 768px)": {
      width: "100%",
    },
      ...
      <Fade right duration={2000} distance="40px">
        <div {...card_body}>
          <div
            ...
            style={{ backgroundColor: theme.educCard }}
          >
            <div className="body-header-title">
              <h2 className="card-title" style={{ color: "#FFFFFF" }}>
                {degree.title}
              </h2>
              <h4 className="card-subtitle" style={{ color: "#FFFFFF" }}>
                {degree.subtitle}
              </h4>
            </div>
